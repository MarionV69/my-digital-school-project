...
export class EstablishmentDetailsDto {
  ...
  @ApiPropertyOptional({
    example: 'legourmetbistrot@gmail.com',
    required: false,
  })
  email?: string | null;
  ...
  @ApiPropertyOptional({
    example:
      'Nous sommes un établissement de restauration spécialisé dans la cuisine française traditionnelle.',
    required: false,
  })
  ...
  @ApiPropertyOptional({
    example: 'https://instagram.com/legourmetbistrot',
    required: false,
  })
  instagram?: string | null;

  @ApiPropertyOptional({
    example: 'https://facebook.com/legourmetbistrot',
    required: false,
  })
