...
export class EstablishmentsService {
  create(createEstablishmentDto: CreateEstablishmentDto) {
    return `This action adds a new establishment ${JSON.stringify(createEstablishmentDto)}`;
  }
  ...
  update(id: number, updateEstablishmentDto: UpdateEstablishmentDto) {
    return `This action updates a #${id} establishment ${JSON.stringify(updateEstablishmentDto)}`;
  }
