    ...
    useEffect(() => {
        ...
        async function getFavorites() {
            try {
                ...
                const favoritesResponses = await api.get(`/establishments/${establishmentId}/favorites`);
                ...
                setError('Impossible de charger les favoris pour le moment. Veuillez réessayer plus tard.');
            } finally {
                setLoading(false);
            }
        };
